...
DROP TABLE IF EXISTS `mayday_backlog`;
CREATE TABLE `mayday_backlog` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `backlog_id` varchar(32) DEFAULT '0' COMMENT '任务id',
  `backlog_name` int(255) DEFAULT NULL COMMENT '任务名称',
  `time` datetime DEFAULT NULL COMMENT '任务时间',
